...
const styles = StyleSheet.create({
  ...
  scroll: {
    flexGrow: 1, alignItems: "center", paddingHorizontal: 24, paddingVertical: 80,
  },
  logo: {
    width: 60,
    height: 60,
  ...
  hint: { alignSelf: 'flex-start', color: '#888', fontSize: 12, marginTop: -8, marginBottom: 20, marginLeft: 2 },
